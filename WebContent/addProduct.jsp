...
<body>
	...
	<div class="container">
		<form name="newProduct" action="./processAddProduct.jsp" class="form-horizontal" method="post" enctype="muitipart/form-data">
	...
	<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="text" name="categoryr" class=form-control" >
		</div>
	</div>
			<div class="form-group row">
